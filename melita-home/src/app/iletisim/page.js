...
title: "İletişim | Melita Home Konya Selçuklu",
  description:
    "Melita Home iletişim bilgileri: Kosova, Seher Sk. No:3/A, 42250 Selçuklu/Konya. Telefon: +90 545 425 09 75. Çalışma saatleri: 08.30 - 20.00.",
    alternates: {
  canonical: "/iletisim",
},
};
        ...
        <div className={styles.wrap}>
          <div className={styles.heroGrid}>
            ...
            <div className={styles.heroCard}>
              <strong>Her gün 08.30 - 20.00 saatleri arasında ulaşabilirsiniz.</strong>
              <span>
            ...
            <div className={styles.contactPanel}>
              ...
              <div className={styles.contactList}>
                ...
                <div className={styles.contactItem}>
                  ...
                  <strong>Her gün 08.30 - 20.00</strong>
                </div>
              </div>
            </div>
